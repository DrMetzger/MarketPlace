...
<hr class="solid">
<button class="btn btn-success" data-toggle="modal" onclick="openModal('modal_insert','', 'insert','taxes')">
...
if (sqlsrv_has_rows($result)) {
    ...
    echo "<td>".$xcod."</td>";
    echo "<td>".$xdesc."</td>";
    echo "<td>".number_format($xvalue, 2, '.', '')."</td>";
    echo "<td>".$xtypeofproduct."</td>";
    echo "<td class='exclude-column'>";
    echo "<button class='btn btn-warning btn-sm' data-toggle='modal' onclick='openModal(\"modal_edit\",".$xcod.", \"edit\", \"taxes\")'>";
    echo "Edit";
    echo "</button>";
    echo "</td>";
    echo "<td class='exclude-column'>";
    echo "<button class='btn btn-primary btn-sm' data-toggle='modal' onclick='openModal(\"modal_view\", ".$xcod.", \"view\", \"taxes\")'>";
    echo "View";
    echo "</button>";
    echo "</td>";
    echo "<td class='exclude-column'>";
    echo "<button class='btn btn-danger btn-sm' data-toggle='modal' onclick='openModal(\"modal_delete\", ".$xcod.", \"delete\", \"taxes\")'>";
    echo "Delete";
    echo "</button>";
    echo "</td>";
    echo "</tr>";
